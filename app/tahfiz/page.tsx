        ...
        <Popover className="relative bg-white">
          <div className="mx-auto flex max-w-7xl items-center justify-between p-6 md:justify-start md:space-x-10 lg:px-8">
                        ...
                        <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                          <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8 lg:grid-cols-2">
                            {solutions.map((item) => (
                              ...
                              >
                                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-gradient-to-r from-purple-600 to-indigo-600 text-white sm:h-12 sm:w-12">
                                  <item.icon
                                    className="h-6 w-6"
                                    aria-hidden="true"
                                  />
            ...
            <div className="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
              ...
              <a
                href="#"
                className="hover:to-orage-600 ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-gradient-to-r from-orange-400 to-orange-500 bg-origin-border px-4 py-2 text-base font-medium text-white shadow-sm hover:from-orange-500"
              >
                Sign up
              </a>
            </div>
                  ...
                  <div className="mt-6">
                    <nav className="grid grid-cols-1 gap-7">
                      {solutions.map((item) => (
                        ...
                        >
                          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
            ...
            <div className="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
              ...
              <div className="relative px-6 py-16 sm:py-24 lg:px-8 lg:py-32">
                ...
                <p className="mx-auto mt-6 max-w-lg text-center text-xl text-indigo-200 sm:max-w-3xl">
                  We strive to congregate at least once a week to discuss, share
                  and learn
                </p>
            ...
            <div className="mt-12 xl:mt-0">
              ...
              <form className="mt-4 sm:flex sm:max-w-md">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="w-full min-w-0 appearance-none rounded-md border border-gray-300 bg-white px-4 py-2 text-base text-gray-900 placeholder-gray-500 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 focus:placeholder:text-gray-400"
