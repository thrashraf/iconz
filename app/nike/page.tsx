...
const trendingProducts = [
  {
    ...
    href: "#",
    imageSrc:
      "https://static.nike.com/a/images/q_auto:eco/t_product_v1/f_auto/dpr_2.0/w_464,c_limit/d8df9df7-c4e4-4eb3-bfd2-4754cb82070f/dri-fit-adv-aps-engineered-short-sleeve-fitness-top-DDWCtD.png",
    imageAlt:
      "Black machined steel pen with hexagonal grip and small white logo at top.",
    availableColors: [{ name: "Black", colorBg: "#111827" }],
  },
  // More products...
]
const collections = [
        ...
        <section aria-labelledby="trending-heading" className="bg-white">
          <div className="py-16 sm:py-24 lg:mx-auto lg:max-w-7xl lg:px-8 lg:py-32">
            <div className="flex items-center justify-between px-4 sm:px-6 lg:px-0">
              ...
              <a
                href="#"
                className="text-grey-600 hover:text-grey-500 hidden text-sm font-semibold sm:block"
              >
                See everything
